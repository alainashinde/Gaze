Installation & Run Instructions (macOS / Windows / Linux)
--------------------------------------------------------
1) Unzip the Gaze_package.zip and open a terminal in the folder (cd Desktop/Gaze_package).
...
7) (Optional) Open the dashboard at http://127.0.0.1:5000 to see the live focus status.
